  ...
  const handleProfilePictureUpload = async (fileToUpload = null) => {
    ...
    try {
      ...
      if (!file.type.startsWith('image/')) {
        toast.error('Please select an image file for the profile picture');
        return;
      }

      // Validate file size (max 5MB)
      if (file.size > 5 * 1024 * 1024) {
        toast.error('Profile picture file size must be less than 5MB');
        return;
      }
            ...
            {activeTab === 'profile' && (
              <div className="max-w-5xl mx-auto w-full">
                  ...
                  <div className="flex items-start gap-6">
                    ...
                    <div className="relative flex-shrink-0">
                      <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-gray-200 shadow-lg">
                        ...
                        <div className={`w-full h-full bg-gray-200 flex items-center justify-center ${profileData.profile_picture_url ? 'hidden' : ''}`}>
                ...
                {!isEditing ? (
                    ...
                    <div className="max-w-6xl mx-auto px-8">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4">
                        ...
                        <div>
                          ...
                          <input
                            type="text"
                            value={profileData.birthday ? new Date(profileData.birthday).toLocaleDateString('en-US', {
                              month: '2-digit',
                              day: '2-digit',
                              year: 'numeric'
                            }) : ''}
                  ...
                  <form onSubmit={(e) => { e.preventDefault(); handleProfileSave(); }} className="space-y-8">
                    <div className="max-w-6xl mx-auto px-8">
                      <h3 className="text-xl font-bold text-primary-700 mb-1">Personal Info</h3>
