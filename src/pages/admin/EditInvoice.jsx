  ...
  return (
    <div className="w-full min-h-screen bg-gray-50 p-0 m-0">
      ...
      <div className="flex justify-end pt-6 border-t border-gray-200 px-8 pb-8">
        ...
        <button type="button" className="ml-4 inline-flex items-center px-8 py-3 border border-gray-300 text-base font-medium rounded-lg shadow-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-150" onClick={() => navigate('/admin/billing')}>
