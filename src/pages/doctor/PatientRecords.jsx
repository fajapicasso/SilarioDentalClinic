...
import { FiArrowLeft, FiUpload, FiEye, FiEyeOff, FiTrash2, FiFileText, FiX, FiPrinter, FiPlus, FiEdit, FiSave, FiDownload, FiUser, FiCalendar, FiClock, FiMapPin, FiFilter } from 'react-icons/fi';
...
const PatientRecords = () => {
  ...
  useEffect(() => {
    ...
    // Date filter using the new system
    if (dateFilter !== 'all') {
      ...
      filtered = filtered.filter(treatment => 
        isDateInRange(treatment.treatment_date, dateFilter, dateFrom, dateTo)
      );
    }
  ...
  }, [treatments, searchQuery, procedureFilter, toothFilter, dateFilter, dateFrom, dateTo]);
                ...
                <div className="flex flex-wrap items-center gap-4 p-4 bg-blue-50 rounded-lg border-2 border-blue-200 shadow-sm">
                  <div className="flex items-center space-x-2">
                    ...
                    <input
                      ...
                      max={dateTo ? dateTo.toISOString().split('T')[0] : new Date().toISOString().split('T')[0]}
