...
const dentalHistory = [
  ...
  }, []); // Remove patientId dependency since patients always use their own ID
                ...
                ${upperTeeth.map(tooth => {
                  ...
                  return `
                    <div class="tooth-container">
                      ...
                      <div class="tooth-symbol" style="background-color: ${symbolInfo?.bgColor || '#fff'}; color: ${symbolInfo?.color || '#000'}; border: 2px solid ${symbolInfo?.borderColor || '#e5e7eb'};">
                        ${symbol}
                      </div>
                    </div>
                  `;
      ...
      <body>
        ...
        <div class="patient-info-grid">
          ...
          <div class="patient-right-column">
            ...
            <div class="info-row">
              <span class="info-label">Fax No.:</span> <span class="info-value">${patient?.fax || ''}</span>
            </div>
            <div class="info-row">
        ...
        <div class="legend-section">
          ...
          <div class="legend-grid">
            ...
            <div class="legend-column">
              ...
              <div class="legend-items">
                <div class="legend-item">
                  <div class="legend-symbol" style="background-color: #fef2f2; border-color: #fecaca; color: #ef4444;">D-</div>
                  <span>Decayed (Caries Indicated for filling)</span>
                </div>
                <div class="legend-item">
                  <div class="legend-symbol" style="background-color: #450a0a; border-color: #991b1b; color: #7f1d1d;">M-</div>
                  <span>Missing due to caries</span>
                </div>
                <div class="legend-item">
                  <div class="legend-symbol" style="background-color: #ecfdf5; border-color: #a7f3d0; color: #10b981;">F-</div>
                  <span>Filled</span>
                </div>
                <div class="legend-item">
                  <div class="legend-symbol" style="background-color: #fef2f2; border-color: #fca5a5; color: #dc2626;">I-</div>
                  <span>Caries indicated for Extraction</span>
                </div>
                <div class="legend-item">
                  <div class="legend-symbol" style="background-color: #f9fafb; border-color: #d1d5db; color: #a3a3a3;">RF-</div>
                  <span>Root Fragment</span>
                </div>
                <div class="legend-item">
                  <div class="legend-symbol" style="background-color: #450a0a; border-color: #dc2626; color: #991b1b;">MO-</div>
                  <span>Missing due to other causes</span>
                </div>
                <div class="legend-item">
                  <div class="legend-symbol" style="background-color: #f5f3ff; border-color: #c4b5fd; color: #8b5cf6;">Im-</div>
            ...
            <div class="legend-column">
              ...
              <div class="legend-items">
                <div class="legend-item">
                  <div class="legend-symbol" style="background-color: #fffbeb; border-color: #fde68a; color: #f59e0b;">J-</div>
                  <span>Jacket Crown</span>
                </div>
                <div class="legend-item">
                  <div class="legend-symbol" style="background-color: #ecfeff; border-color: #a5f3fc; color: #06b6d4;">A-</div>
                  <span>Amalgam Fillings</span>
                </div>
                <div class="legend-item">
                  <div class="legend-symbol" style="background-color: #eff6ff; border-color: #93c5fd; color: #3b82f6;">AB-</div>
                  <span>Abutment</span>
                </div>
                <div class="legend-item">
                  <div class="legend-symbol" style="background-color: #eef2ff; border-color: #a5b4fc; color: #6366f1;">P-</div>
                  <span>Pontic</span>
                </div>
                <div class="legend-item">
                  <div class="legend-symbol" style="background-color: #fdf2f8; border-color: #f9a8d4; color: #ec4899;">In-</div>
                  <span>Inlay</span>
                </div>
                <div class="legend-item">
                  <div class="legend-symbol" style="background-color: #f7fee7; border-color: #bef264; color: #84cc16;">FX-</div>
                  <span>Fixed Cure Composite</span>
                </div>
                <div class="legend-item">
                  <div class="legend-symbol" style="background-color: #f9fafb; border-color: #d1d5db; color: #6b7280;">Rm-</div>
            ...
            <div class="legend-column">
              ...
              <div class="legend-items">
                <div class="legend-item">
                  <div class="legend-symbol" style="background-color: #450a0a; border-color: #dc2626; color: #991b1b;">X-</div>
                  <span>Extraction due to caries</span>
                </div>
                <div class="legend-item">
                  <div class="legend-symbol" style="background-color: #450a0a; border-color: #991b1b; color: #7f1d1d;">XO-</div>
                  <span>Extraction due to other causes</span>
                </div>
                <div class="legend-item">
                  <div class="legend-symbol" style="background-color: #ecfdf5; border-color: #a7f3d0; color: #10b981;">✔-</div>
                  <span>Present Teeth</span>
                </div>
                <div class="legend-item">
                  <div class="legend-symbol" style="background-color: #f8fafc; border-color: #cbd5e1; color: #64748b;">Cm-</div>
                  <span>Congenitally missing</span>
                </div>
                <div class="legend-item">
                  <div class="legend-symbol" style="background-color: #f7fee7; border-color: #bef264; color: #84cc16;">Sp-</div>
            ...
            <div class="section-block">
              ${dentalHistory.map((question, index) => `
                <div class="question-block">
                  ...
                  <span class="question-response">${dentalChart.dentalHistory?.[`question_${index}`] || '_____________________'}</span>
                </div>
              `).join('')}
            </div>
          </div>
              ...
              <div className="grid grid-cols-2 gap-8 text-sm">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="flex-1">{patient.dental_insurance || ''}</span>
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="flex-1">{patient.fax || ''}</span>
                  </div>
          ...
          <div className="p-6">
            {editMode ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {/* Right Column - Medical History Questions */}
                <div className="space-y-4 ml-16">
                  ...
                  {/* Questions 11-12 */}
                  {medicalHistory.slice(9, 11).map((question, index) => (
                    <div key={index + 9}>
                      <label className="block text-sm font-medium text-gray-700 mb-1">{index + 11}. {question}</label>
                      <textarea
                        className="w-full rounded-md border border-gray-300 px-3 py-2 focus:ring-primary-500 focus:border-primary-500"
                        placeholder="Response"
                        value={dentalChart.medicalHistory?.[`question_${index + 9}`] || ''}
                        onChange={e => updateChartData('medicalHistory', `question_${index + 9}`, e.target.value)}
                        rows={2}
                      />
                    </div>
                  ))}
                ...
                <div className="col-span-2 mt-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 gap-4 bg-gray-50 p-4 rounded-md">
                    {medicalConditions.map(condition => (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div className="space-y-2 ml-16">
                  ...
                  {/* Questions 11-12 */}
                  {medicalHistory.slice(9, 11).map((question, index) => (
                    <div key={index + 9} className="flex items-start">
                      <span className="font-bold mr-2 text-sm">{index + 11}.</span>
                      <div className="flex-1">
                        <span className="font-bold text-sm">{question}</span>
                        <span className="text-gray-700 text-sm ml-2">{dentalChart.medicalHistory?.[`question_${index + 9}`] || ''}</span>
                      </div>
                    </div>
                  ))}
                </div>
