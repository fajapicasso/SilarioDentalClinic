        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <select className="block w-full pl-3 pr-10 py-2.5 text-base border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 text-sm rounded-lg" value={paymentMethod} onChange={e => setPaymentMethod(e.target.value)}>
            ...
            <div>
              ...
              <select className="block w-full pl-3 pr-10 py-2.5 text-base border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 text-sm rounded-lg" value={paymentStatus} onChange={e => setPaymentStatus(e.target.value)}>
            ...
            <div>
              ...
              <div className="flex rounded-lg shadow-sm">
                <input type="number" className="flex-1 border border-gray-300 rounded-l-lg shadow-sm py-2.5 px-3 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="0" value={discount} onChange={e => setDiscount(e.target.value)} min="0" />
                <select className="border-l-0 border-gray-300 rounded-r-lg shadow-sm py-2.5 px-3 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" value={discountType} onChange={e => setDiscountType(e.target.value)}>
