...
const Payments = () => {
  ...
  // Function to extract rejection message from payment notes
  const extractRejectionMessage = async (invoiceId) => {
    try {
      const { data: payments, error } = await supabase
        .from('payments')
        .select('notes, approval_status')
    ...
    <div className="space-y-4 sm:space-y-6">
        ...
        <div className="border-b border-gray-200 mb-4 sm:mb-6">
          <nav className="-mb-px flex space-x-4 sm:space-x-8 overflow-x-auto">
            <button
              ...
              className={`flex-shrink-0 whitespace-nowrap pb-3 sm:pb-4 px-2 sm:px-1 border-b-2 font-medium text-sm sm:text-base ${
                activeTab === 'pending'
          ...
          <div className="bg-white shadow-lg rounded-lg overflow-hidden">
            <div className="px-4 sm:px-6 py-4 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-gray-200">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <h3 className="text-base sm:text-lg font-semibold text-gray-900">Pending Invoices</h3>
                  <p className="text-xs sm:text-sm text-gray-600">Make payments for your outstanding bills</p>
                </div>
              </div>
            </div>
                      ...
                      return (
                        <div key={invoice.id} className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <div className="text-right">
                                <div className="text-sm font-semibold text-gray-900">₱{invoice.total_amount.toFixed(2)}</div>
                                {invoice.amount_paid > 0 && (
                                  <div className="text-xs text-green-600">
                                    Paid: ₱{invoice.amount_paid.toFixed(2)}
                                  </div>
                          ...
                          <div className="mt-4 flex flex-col sm:flex-row gap-2">
                            {isInvoicePaidInSession(invoice.id) ? (
                              <span className="inline-flex items-center justify-center px-4 py-2 text-sm leading-4 font-medium text-green-700 bg-green-100 rounded-md">
                                <FiCheck className="mr-2" />
                                Submitted
                              </span>
                            ) : (
                              <button
                                ...
                                className="flex-1 inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-150"
                              >
                            ...
                            <button
                              onClick={() => setSelectedInvoice(invoice)}
                              className="flex-1 inline-flex items-center justify-center px-4 py-2 border border-gray-300 text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-150"
                            >
              ...
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-3 sm:space-y-0">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-xs sm:text-sm text-gray-600">Track your submitted payment confirmations</p>
                  </div>
                </div>
              <button 
            ...
            <div className="border-t border-gray-200">
              {paymentHistory.length > 0 ? (
                  ...
                  <div className="space-y-4 p-4">
                    {(() => {
                      ...
                      return Array.from(grouped.values()).map((payment) => {
                        ...
                        return (
                          <div key={payment.invoice_id} className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                            {/* Payment Header */}
                            <div className="flex items-center justify-between mb-3">
                              <div className="flex items-center">
                                <div className="h-8 w-8 rounded-full bg-blue-100 flex items-center justify-center">
                              ...
                              {statusLower === 'rejected' && (
                                <div className="mt-3 p-3 bg-red-50 border border-red-200 rounded-md">
                                  <div className="flex items-start">
                                    ...
                                    <p className="text-sm text-red-700 font-medium">Payment rejected. Pay again with valid proof.</p>
                                  </div>
                                </div>
                              )}
                            </div>
                            ...
                            <div className="mt-4 flex flex-col sm:flex-row gap-2">
                              <button
                                type="button"
                                onClick={() => openProofGalleryForInvoice(payment.invoice_id)}
                                className="flex-1 inline-flex items-center justify-center px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-all duration-200"
                              >
                              ...
                              {payment.invoices && (
                                <>
                                  <button
                                    type="button"
                                    onClick={() => handleDownloadPDF(payment.invoice_id)}
                                    className="flex-1 inline-flex items-center justify-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200"
                                  >
                ...
                <div className="text-center py-8 sm:py-12 px-4">
                  ...
                  <h3 className="mt-2 text-sm sm:text-base font-medium text-gray-900">No payment history</h3>
      ...
      {showPaymentModal && selectedInvoice && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 flex items-center justify-center p-4">
          <div className="relative bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[95vh] overflow-y-auto">
            {showPaymentSuccess ? (
              ...
              <>
                ...
                <form onSubmit={handlePaymentSubmit} className="grid grid-cols-1 lg:grid-cols-2">
                  ...
                  <div className="bg-gray-50 lg:bg-white p-4 sm:p-6 flex flex-col items-center text-black border-t lg:border-t-0 lg:border-l border-gray-200">
                    {paymentMethod === 'gcash' && (
                      <>
                        <div className="bg-white p-3 rounded mb-3 w-48 sm:w-64 max-w-full">
                          <img 
...
Saturday: 8:00 AM - 5:00 PM
                  ...
                  {/* Footer with buttons */}
                  <div className="col-span-1 lg:col-span-2 flex flex-col sm:flex-row justify-end gap-3 p-4 border-t">
                    <button
                      type="button"
                      className="w-full sm:w-auto px-4 py-3 sm:py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-150"
                      onClick={() => setShowPaymentModal(false)}
                    >
                      Cancel
                    </button>
                    <button
                      type="submit"
                      className={`w-full sm:w-auto px-4 py-3 sm:py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-150 ${
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] flex flex-col">
            ...
            <div className="p-4 overflow-y-auto flex-1">
              ...
              {proofGallery && proofGallery.length > 0 ? (
                <div className="flex gap-3 overflow-x-auto p-1 pb-4" style={{scrollbarWidth: 'thin'}}>
                  {proofGallery.map((p, idx) => (
                    <div key={idx} className={`min-w-[280px] max-w-[300px] bg-white rounded-lg border-2 overflow-hidden ${
            ...
            <div className="p-4 border-t flex justify-end flex-shrink-0 bg-white">
              <button
                type="button"
                className="px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-150"
                onClick={() => setShowProofModal(false)}
              >
                Close
              </button>
