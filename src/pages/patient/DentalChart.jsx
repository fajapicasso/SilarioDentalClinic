// src/pages/patient/DentalChart.jsx - Patient Dental Chart with Enhanced Connection Handling
...
const dentalHistory = [
  ...
  useEffect(() => {
    // Log page view
    logPageView('Patient Dental Chart', 'medical_records', 'dental_chart');
  ...
  const saveDentalChart = async (retryCount = 0) => {
    ...
    try {
      ...
      if (userProfile?.role !== 'patient') {
        toast.error('Access denied. Only patients can save dental charts.');
        return;
      }
                  ...
                  <div class="teeth-side">
                    ...
                    <div class="teeth-row">
                      ${temporaryTeeth.upperRight.map(tooth => {
                        ...
                        return `
                          <div class="tooth">
                            <div class="tooth-symbol">${symbol}</div>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b border-gray-200">
        <div className="px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Comprehensive Dental Chart</p>
              </div>
            </div>
          ...
          {/* Patient Info and Action Buttons in Header */}
          <div className="mt-3 space-y-3">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="px-3 py-1.5 text-xs font-medium rounded-md text-blue-600 bg-blue-50 hover:bg-blue-100"
              >
              ...
              {editMode ? (
                <>
                  <button
                    onClick={cancelEdit}
                    disabled={isSaving}
                    className="flex items-center justify-center px-3 py-1.5 border border-gray-300 text-xs font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 disabled:bg-gray-100"
                  >
                  ...
                  <button
                    ...
                    disabled={isSaving}
                    className="flex items-center justify-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md text-white bg-green-600 hover:bg-green-700 disabled:bg-green-300"
                  >
                    {isSaving ? (
                    ...
                    <span className="truncate">Save Chart</span>
                  </button>
                </>
              ) : (
                <>
                  <button
                    ...
                    className="flex items-center justify-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center px-3 py-1.5 border border-gray-300 text-xs font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50"
                  >
            ...
            {/* Connection Status Button in Header */}
            {connectionStatus === 'failed' && (
              <button
                onClick={retryConnection}
                className="w-full flex items-center justify-center px-3 py-1.5 border border-red-300 text-xs font-medium rounded-md text-red-700 bg-red-50 hover:bg-red-100"
              >
      ...
      <div className="px-4 py-4 space-y-4">
        {/* Edit Mode Notice - Mobile Optimized */}
        {editMode && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-3">
            <div className="flex items-start">
              ...
              <div className="ml-2">
                <h3 className="text-sm font-medium text-green-800">Edit Mode Active</h3>
                <p className="mt-1 text-xs text-green-700">
                  You can now edit your dental chart. Update medical history, dental history, and patient information.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Main Dental Chart Layout - Mobile Optimized */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          {/* Header with Logo - Mobile Layout */}
              ...
              <div className="space-y-3 text-sm">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="flex flex-col">
                    <span className="font-bold text-xs text-gray-600">Name:</span>
                    <span className="text-sm">{patient.full_name}</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="font-bold text-xs text-gray-600">Age:</span>
                    <span className="text-sm">{patient.birthday ? calculateAge(patient.birthday) : ''} years</span>
                  </div>
                </div>
                
                <div className="flex flex-col">
                  <span className="font-bold text-xs text-gray-600">Address:</span>
                  <span className="text-sm">{patient.address}</span>
                </div>
                
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="flex flex-col">
                    <span className="font-bold text-xs text-gray-600">Sex:</span>
                    <span className="text-sm">{patient.gender ? patient.gender.charAt(0).toUpperCase() + patient.gender.slice(1) : ''}</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="font-bold text-xs text-gray-600">Nationality:</span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="flex flex-col">
                    <span className="font-bold text-xs text-gray-600">Home No.:</span>
                    <span className="text-sm">{patient.phone || ''}</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="font-bold text-xs text-gray-600">Cell/Mobile:</span>
                    <span className="text-sm">{patient.mobile || patient.phone || ''}</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div className="flex flex-col">
                    <span className="font-bold text-xs text-gray-600">Office No.:</span>
                    <span className="text-sm">{patient.office_no || ''}</span>
                  </div>
                </div>
                
                <div className="flex flex-col">
                  <span className="font-bold text-xs text-gray-600">Birthdate:</span>
                  <span className="text-sm">{patient.birthday || ''}</span>
                </div>
                
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="flex flex-col">
                    <span className="font-bold text-xs text-gray-600">Dental Insurance:</span>
                    <span className="text-sm">{dentalChart.patientInfo?.dental_insurance || ''}</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="font-bold text-xs text-gray-600">Effective Date:</span>
                    <span className="text-sm">{dentalChart.patientInfo?.effective_date || patient.effective_date || ''}</span>
                  </div>
                </div>
        ...
        {/* Tooth Symbol Selection - Mobile Optimized (Hidden for patients) */}
              ...
              <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2">
                {Object.entries(chartSymbols).map(([symbol, description]) => (
                  <button
                    ...
                    className={`p-2 border rounded-md text-center hover:bg-blue-100 ${
                    ...
                    title={description}
                  >
                    <div className="font-bold text-sm text-red-600">{symbol}</div>
                    <div className="text-xs text-gray-600 mt-1">{description.substring(0, 15)}...</div>
                  </button>
                ))}
                <button
                  onClick={() => updateToothData(selectedTooth, 'symbol', '')}
                  className="p-2 border rounded-md text-center hover:bg-red-100 bg-red-50 border-red-300"
                  title="Clear symbol"
                >
                  <div className="font-bold text-sm text-red-600">Clear</div>
                  <div className="text-xs text-gray-600 mt-1">Remove</div>
                </button>
              </div>
            </div>
          </div>
