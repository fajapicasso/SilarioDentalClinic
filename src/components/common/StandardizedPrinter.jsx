...
const StandardizedPrinter = {
  ...
  // Generate standardized dental chart HTML for printing
  generateStandardizedDentalChartHTML: (dentalChart, enhancedChartSymbols) => {
    try {
  ...
  generateStandardizedPrintHTML: (patient, dentalChart, currentDate, enhancedChartSymbols) => {
    ...
    const dentalHistoryQuestions = StandardizedPrinter.dentalHistory;
    const medicalConditionsList = StandardizedPrinter.medicalConditions;
  ...
  <body>
    ...
    <div class="patient-info-grid">
      ...
      <div class="patient-right-column">
        <div class="info-row">
          <span class="info-label">Age:</span> <span class="info-value">${patient?.birthday ? StandardizedPrinter.calculateAge(patient.birthday) : ''}</span>
        </div>
        <div class="info-row">
    ...
    <div class="info-grid">
      ...
      <div class="info-row">
        ...
        <div class="info-grid">
          ${dentalHistoryQuestions.map((question, index) => `
            <div class="info-row">
  ...
  printStandardizedDentalChart: (patient, dentalChart, enhancedChartSymbols, toast) => {
    try {
      ...
      const printHTML = StandardizedPrinter.generateStandardizedPrintHTML(
        patient, 
        dentalChart, 
        currentDate, 
      ...
      toast.success('Opening standardized print dialog...');
    } catch (error) {
      console.error('Error printing standardized dental chart:', error);
      toast.error('Failed to print dental chart. Please try again.');
    }
  }
};

export default StandardizedPrinter;